...
from cadrig.adapters.freecad import FreeCADKernelAdapter, FreeCADUnavailableError
...
def build_parser() -> argparse.ArgumentParser:
    ...
    ask_parser.add_argument("--api-key-env", default="CADRIG_MODEL_API_KEY")
    ...
    macro_parser.add_argument("--api-key-env", default="CADRIG_MODEL_API_KEY")
...
def _run_cadgenbench_command(args: argparse.Namespace) -> int:
    from cadrig.benchmarks.cadgenbench import (
    ...
    try:
        ...
        if args.benchmark_command == "cohort":
            from cadrig.benchmarks.cadgenbench.dataset import discover_dataset_tasks
        ...
        if args.benchmark_command == "harness-eval":
            from cadrig.benchmarks.cadgenbench.common import write_json_atomic
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.command == "macro":
        base_url = args.model_base_url or os.environ.get("CADRIG_MODEL_BASE_URL")
        model_name = args.model or os.environ.get("CADRIG_MODEL")
                ...
                json.dumps(
                    {
                        "error": (
                            ...
                            "CADRIG_MODEL_BASE_URL and CADRIG_MODEL environment variables"
                        )
                    },
                    indent=2,
                )
